...
var dialogue : DialogueEntry4[] = [new DialogueEntry4()];
private var display : DialogueEntry4 = new DialogueEntry4();
...
class DialogueEntry4 {
var name : String;
var longText : String;
var img : Texture2D;
var choices : DialogueChoice4[];
...
var passwords : DialogueChoice4[];
var incorrect : int;
var exit : DialogueChoice4;
var align : int;
var mode : int;
var narration : AudioClip[];
var script : String;
// 0 - next, 1 - choice, 2 - password, 3 - event, 4 - end
function DialogueEntry4 () {
name = "Name";
longText = "New entry";
next = 0;
editor = false;
incorrect = 0;
align = 0;
exit = new DialogueChoice4("Exit");
mode = 0;
}
}
class DialogueChoice4 {
var shortText : String;
var next : int;
var editor : boolean;
function DialogueChoice4 () {
shortText = "New Choice";
editor = false;
}
function DialogueChoice4 (s:String) {
shortText = s;
editor = false;
}
}
