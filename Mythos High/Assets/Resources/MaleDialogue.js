...
var dialogue : DialogueEntry3[] = [new DialogueEntry3()];
private var display : DialogueEntry3 = new DialogueEntry3();
...
class DialogueEntry3 {
var name : String;
var longText : String;
var img : Texture2D;
var choices : DialogueChoice3[];
...
var passwords : DialogueChoice3[];
var incorrect : int;
var exit : DialogueChoice3;
var align : int;
var mode : int;
var narration : AudioClip[];
var script : String;
// 0 - next, 1 - choice, 2 - password, 3 - event, 4 - end
function DialogueEntry3 () {
name = "Name";
longText = "New entry";
next = 0;
editor = false;
incorrect = 0;
align = 0;
exit = new DialogueChoice3("Exit");
mode = 0;
}
}
class DialogueChoice3 {
var shortText : String;
var next : int;
var editor : boolean;
function DialogueChoice3 () {
shortText = "New Choice";
editor = false;
}
function DialogueChoice3 (s:String) {
shortText = s;
editor = false;
}
}
...
switch(display.mode) {
	case 0:
		...
		if (GUI.Button(Rect(Screen.width-84,Screen.height-84,64,64),"Next","arrow"))
			{ 
				Application.LoadLevel ("MaleFirstQuestion");
			}
		}
	break;
	}
