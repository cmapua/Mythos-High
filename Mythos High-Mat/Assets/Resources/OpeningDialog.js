...
var dialogue : DialogueEntry2[] = [new DialogueEntry2()];
private var display : DialogueEntry2 = new DialogueEntry2();
...
class DialogueEntry2 {
var name : String;
var longText : String;
var img : Texture2D;
var choices : DialogueChoice2[];
...
var passwords : DialogueChoice2[];
var incorrect : int;
var exit : DialogueChoice2;
var align : int;
var mode : int;
var narration : AudioClip[];
var script : String;
// 0 - next, 1 - choice, 2 - password, 3 - event, 4 - end
function DialogueEntry2 () {
name = "Name";
longText = "New entry";
next = 0;
editor = false;
incorrect = 0;
align = 0;
exit = new DialogueChoice2("Exit");
mode = 0;
}
}
class DialogueChoice2 {
var shortText : String;
var next : int;
var editor : boolean;
function DialogueChoice2 () {
shortText = "New Choice";
editor = false;
}
function DialogueChoice2 (s:String) {
shortText = s;
editor = false;
}
}
