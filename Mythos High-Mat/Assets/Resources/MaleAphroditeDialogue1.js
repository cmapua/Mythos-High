...
var dialogue : DialogueEntry5[] = [new DialogueEntry5()];
private var display : DialogueEntry5 = new DialogueEntry5();
...
class DialogueEntry5 {
var name : String;
var longText : String;
var img : Texture2D;
var choices : DialogueChoice5[];
...
var passwords : DialogueChoice5[];
var incorrect : int;
var exit : DialogueChoice5;
var align : int;
var mode : int;
var narration : AudioClip[];
var script : String;
// 0 - next, 1 - choice, 2 - password, 3 - event, 4 - end
function DialogueEntry5 () {
name = "Name";
longText = "New entry";
next = 0;
editor = false;
incorrect = 0;
align = 0;
exit = new DialogueChoice5("Exit");
mode = 0;
}
}
class DialogueChoice5 {
var shortText : String;
var next : int;
var editor : boolean;
function DialogueChoice5 () {
shortText = "New Choice";
editor = false;
}
function DialogueChoice5 (s:String) {
shortText = s;
editor = false;
}
}
...
switch(display.mode) {
	case 0:
		...
		if (GUI.Button(Rect(Screen.width-84,Screen.height-84,64,64),"Next","arrow"))
			{ 
				Application.LoadLevel ("FemaleFirstQuestion");
			}
		}
	break;
	}
